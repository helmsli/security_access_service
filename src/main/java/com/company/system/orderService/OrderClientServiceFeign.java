...
public interface OrderClientServiceFeign {
	...
	public ProcessResult addOrderMain(@PathVariable(value = "category") String category,
			@PathVariable(value = "dbId") String dbId, @PathVariable(value = "orderId") String orderId,
			@RequestBody OrderMainContext orderMain);

	@GetMapping(value = "/orderGateway/{category}/{dbId}/{orderId}/startOrder")
	public ProcessResult startOrderMain(@PathVariable(value = "category") String category,
			@PathVariable(value = "dbId") String dbId, @PathVariable(value = "orderId") String orderId);

	@PostMapping(value = "/orderGateway/{category}/{dbId}/{orderId}/putContextData")
	public ProcessResult putContextData(@PathVariable(value = "category") String category,
			@PathVariable(value = "dbId") String dbId, @PathVariable(value = "orderId") String orderId,
			@RequestBody OrderMainContext orderMainContext);

	@PostMapping(value = "/orderGateway/{category}/{dbId}/{orderId}/getContextData")
	public ProcessResult getContextData(@PathVariable(value = "category") String category,
			@PathVariable(value = "dbId") String dbId, @PathVariable(value = "orderId") String orderId,
			@RequestBody JsonRequest jsonRequest);

	@PostMapping(value = "/orderGateway/{category}/{dbId}/{orderId}/mJumpToNext")
	public ProcessResult manualJumpToNextStep(@PathVariable(value = "category") String category,
			@PathVariable(value = "dbId") String dbId, @PathVariable(value = "orderId") String orderId,
